...
uint8_t initController(void)
{
    ...
    if (lightTimerHandle == NULL)
    {
        ...
        if (lightTimerHandle == NULL)
        {
            sciPrintText(sciREG, "Unable to initialize light timer", 32);
        }
    }
    /* USER CODE END */
...
static void controllerTask(void *pvParameters)
{
    ...
    if (lightServiceStatus == 0)
    {
        ...
        sciPrintText(sciREG, "Unable to initialize light service", 34);
        /* USER CODE END */
    }
    else
    {
        ...
        /* USER CODE BEGIN */
        // Start light timer
        BaseType_t xReturned1 = xTimerStart(lightTimerHandle, 0);
        /* USER CODE END */
    }
